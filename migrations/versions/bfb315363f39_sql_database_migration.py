...
Revision ID: bfb315363f39
Revises: f5053bd3f311
Create Date: 2024-12-12 14:58:25.439301
...
revision = 'bfb315363f39'
down_revision = 'f5053bd3f311'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('target_lng', sa.String(length=50), nullable=True),
